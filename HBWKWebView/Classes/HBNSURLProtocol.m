...
static NSString* const KHBNSURLProtocolKey = @"KHBNSURLProtocolKey";
@interface HBNSURLProtocol ()<NSURLSessionDelegate>
@property (nonnull,strong) NSURLSessionDataTask *task;

@end


@implementation HBNSURLProtocol
...
+ (BOOL)canInitWithRequest:(NSURLRequest *)request
{
    ...
    {
        //看看是否已经处理过了，防止无限循环
        if ([NSURLProtocol propertyForKey:KHBNSURLProtocolKey inRequest:request])
            return NO;
        return YES;
    }
    return NO;
...
- (void)startLoading
{
    ...
    [NSURLProtocol setProperty:@YES forKey:KHBNSURLProtocolKey inRequest:mutableReqeust];
